...
public sealed class AnimatedTilemapFrame : IEnumerable<TilemapLayer>
{
    ...
    /// <summary>
    /// Gets the <see cref="TilemapLayer"/> element at the specified index in this <see cref="AnimatedTilemapFrame"/>.
    /// </summary>
    ...
    /// <summary>
    /// Gets the <see cref="TilemapLayer"/> element with the specified name in this <see cref="AnimatedTilemapFrame"/>.
    /// </summary>
    ...
    /// </summary>
    /// <param name="duration">The duration to assign the <see cref="AnimatedTilemapFrame"/>.</param>
    ...
    /// <summary>
    /// Get the <see cref="TilemapLayer"/> element at the specified index in this <see cref="AnimatedTilemapFrame"/>.
    /// </summary>
    /// <param name="index">The index of the <see cref="TilemapLayer"/> element to locate.</param>
    /// <param name="layer">
