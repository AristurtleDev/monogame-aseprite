...
public sealed class Tilemap : IEnumerable<TilemapLayer>
{
    ...
    /// </summary>
    /// <param name="layerIndex">The index of the <see cref="TilemapLayer"/> element to locate.</param>
    /// <returns>The <see cref="TilemapLayer"/> element located.</returns>
    ...
    /// </summary>
    /// <param name="layerName">The name of the <see cref="TilemapLayer"/> element to locate.</param>
    /// <returns>The <see cref="TilemapLayer"/> element located.</returns>
    ...
    /// </summary>
    /// <param name="name">The name to assign <see cref="Tilemap"/>.</param>
    ...
    /// </param>
    /// <returns>The <see cref="TilemapLayer"/> created by this method.</returns>
    ...
    /// </summary>
    /// <param name="index">The index of the <see cref="TilemapLayer"/> element to locate.</param>
    /// <returns>The <see cref="TilemapLayer"/> element located.</returns>
    /// <exception cref="ArgumentOutOfRangeException">
    /// Thrown if the specified index is less than zero or is greater than or equal to the total number of 
    /// <see cref="TilemapLayer"/> elements in this <see cref="Tilemap"/>.
    ...
    /// Gets the <see cref="TilemapLayer"/> element with the specified name in this <see cref="Tilemap"/>.
    /// </summary>
    /// <param name="name">The name of the <see cref="TilemapLayer"/> element to locate.</param>
    /// <returns>The <see cref="TilemapLayer"/> located.</returns>
    /// <exception cref="KeyNotFoundException">
    /// Thrown if this <see cref="Tilemap"/> does not contain a <see cref="TilemapLayer"/> element with the 
    /// specified name.
    /// </exception>
    ...
    /// </summary>
    /// <param name="layer">The <see cref="TilemapLayer"/> element to remove from this <see cref="Tilemap"/>.</param>
    /// <returns>
    ...
    /// </param>
    /// <param name="position">The x- and y-coordinate location to render this <see cref="Tilemap"/> at.</param>
    /// <param name="color">The color mask to apply when rendering this <see cref="Tilemap"/>.</param>
    ...
    /// <param name="position">The x- and y-coordinate location to render this <see cref="Tilemap"/> at.</param>
    /// <param name="color">The color mask to apply when rendering this <see cref="Tilemap"/>.</param>
    /// <param name="scale">The amount of scaling to apply when rendering this <see cref="Tilemap"/>.</param>
    /// <param name="layerDepth">The layer depth to apply when rendering this <see cref="Tilemap"/>.</param>
